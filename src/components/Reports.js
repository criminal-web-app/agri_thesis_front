...
class Reports extends Component {
    ...
    render() {
        ...
        st.data.map((report)=> reports.push(
            <Button key={report.id} color={id===report.id ? "primary" : "secondary"} style={{width: '100%', marginBottom: '5px'}}
                ...
                <Row>
                    ...
                    <Col>
                        ...
                        >
                            ...
                            <Tooltip />
                            <Legend />
                            <Bar dataKey="fw" fill="#8884d8" label={renderCustomBarLabel}></Bar>
                            {console.log(renderCustomBarLabel)}
                            <Bar dataKey="bw" fill="#82ca9d" label={renderCustomBarLabel}/>
                        </BarChart>
                    </Col>
                </Row>
